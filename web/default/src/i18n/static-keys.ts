...
export const STATIC_I18N_KEYS = [
  ...
  'Quota Code',
  'Subscription Code',
  'Choose what this redemption code grants',
  'Please select a subscription plan',
  'The selected plan will be granted when redeemed',
  'Value',
  'Plan #{{id}}',
  'Subscription redeemed successfully: {{plan}}',
  'Subscription Plan',
  ...
  'Enable embedded purchase',
  'Users open an internal purchase page instead of built-in gateways',
  'Purchase page URL',
  'Shown inside an iframe with an external-open fallback',
  'Fallback instructions',
  'After purchase, copy the redemption code and redeem it in your wallet.',
  'Displayed when iframe loading is blocked or unclear',
  'Save embedded purchase settings',
  'Purchase Redemption Code',
  'Buy a quota or subscription code from the embedded page',
  'Redeem in Wallet',
  'Embedded purchase is currently disabled.',
  'No purchase URL configured.',
  'Open purchase page externally',
